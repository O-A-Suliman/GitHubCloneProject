...
export default function Profile({ setUser }: { setUser: (u: User | null) => void }){
  const [form, setForm] = useState<Partial<User>>({ first_name:'', last_name:'', email:'' })
      ...
      <div className="card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-row">
            ...
            <input name="first_name" value={form.first_name as string} onChange={handleChange} />
          </div>
          <div className="form-row">
            <label>Last name</label>
            <input name="last_name" value={form.last_name as string} onChange={handleChange} />
          </div>
          <div className="form-row">
            <label>Email</label>
            <input type="email" name="email" value={form.email as string} onChange={handleChange} />
          </div>
